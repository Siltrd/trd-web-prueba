          ...
          <div className={`${styles.aboutMeBlock} ${styles.editorialFixedBlock}`}>
            ...
            <div className={styles.checkItem}>
              ...
              <div>
                ...
                <p>
                  Con una trayectoria que integra abogacía, coaching estratégico, PNL, mindfulness,
                  meditación, yoga y disciplinas somáticas, Ivy articula ciencia contemporánea y
                  transformación interior aplicada, impulsando cambios profundos — en lo emocional,
                  profesional y esencial.
                </p>
              </div>
            </div>
            ...
            <div className={styles.checkItem}>
              ...
              <div>
                ...
                <p>
                  Lo que comenzó como una búsqueda individual, hoy impulsa una comunidad decidida a
                  verse, transformarse y crear dirección propia. Porque el cambio real es posible — para
                  quien elige hacerlo.
                </p>
              </div>
            </div>
