const results = {
  friccion: {
    title: 'Fricción interna',
    diagnostico: 'Hay algo en vos que quiere avanzar, y otra parte que tira del freno. No estás inmóvil, pero tampoco en marcha plena. Vivís en un diálogo interno constante, una especie de ruido de fondo que te acompaña aunque no lo nombres. Esa tensión que te incomoda… también contiene energía. Tenés una chispa encendida. Solo falta dirigirla.',
    ...
    cta: {
      ...
      precio: '$9',
      acceso: 'Acceso inmediato al descargable + Bonus: audio “la pregunta que cambia el eje”'
    }
  },
  pausa: {
    title: 'Pausa emocional',
    diagnostico: 'No estás bloqueado por desidia ni por falta de ideas. Estás en pausa porque hay algo que aún no fue nombrado. Tu cuerpo lo registra antes que tu mente: no avanzás porque hay una parte de vos que está cuidando un duelo, un dolor, una pérdida o una energía que todavía no volvió a vos.',
  ...
  camuflaje: {
    title: 'Camuflaje funcional',
    diagnostico: 'Desde fuera, todo parece en orden: cumplís, respondés, avanzás. Pero hay una distancia cada vez más molesta entre lo que hacés y lo que de verdad querés. Te fuiste adaptando tanto a lo que “debía ser”, que ya no sabés si estás viviendo tu historia o la de otro.',
    ...
    cta: {
      ...
      precio: '$9',
      acceso: 'Acceso instantáneo a la guía + modelo visual de claridad personal'
    }
  },
  bucle: {
    title: 'Bucle reflexivo',
    diagnostico: 'Sabés que necesitás avanzar, pero no podés evitar darle mil vueltas antes de moverte. Tu búsqueda de certezas te mantiene atrapado en un ciclo que no termina de resolverse. Analizás escenarios, errores, consecuencias… y terminás agotado sin haber hecho nada.',
  ...
  impulso: {
    ...
    diagnostico: 'Tenés energía, ideas, voluntad. Pero no hay un eje claro que ordene todo eso. Accionás, pero sin dirección firme. Te movés rápido, pero sin saber si eso responde a tu deseo real o a una reacción automática. Avanzás, pero no te sentís satisfecho.',
    ...
    cta: {
      ...
      precio: '$7',
      acceso: 'Acceso inmediato al cuaderno editable + audio de alineación express'
    }
  },
  miedo: {
    title: 'Miedo simbólico',
    diagnostico: 'Sabés lo que querés. Y podrías hacerlo. Pero una parte tuya lo vive como riesgo demasiado alto. No es miedo al fracaso, sino al impacto que tendría tu cambio: lo que se rompería, lo que tendrías que dejar, lo que ya no podrías sostener.',
  ...
  fuga: {
    title: 'Fuga de energía',
    diagnostico: 'Tenés ideas. Tenés intención. Empezás con fuerza. Pero algo se diluye en el camino. Saltás de una cosa a otra, buscás nuevas fórmulas, nuevos estímulos… y en el fondo, sabés que no estás cerrando nada del todo.',
    ...
    cta: {
      ...
      precio: '$7',
      acceso: 'Acceso inmediato al plan + audio guía descargable'
    }
  },
  freno: {
    title: 'Freno inconsciente',
    diagnostico: 'Sabés cómo hacerlo, pero no lo hacés. No es duda. Es freno invisible. Cuando te acercás a moverte, algo se tensa, se cierra o se frena en silencio.',
  ...
  contradiccion: {
    title: 'Contradicción interna',
    diagnostico: 'Hay dos partes de vos activas, con fuerzas opuestas. Una quiere avanzar. Otra no lo permite. Una sabe lo que quiere. Otra lo pone en duda. No estás confundido: estás en plena transición interna.',
